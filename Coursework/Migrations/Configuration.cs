   namespace Coursework.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Coursework.DAL.SiteContext>
    {
        ...
        protected override void Seed(SiteContext context)
        {
            ...
            {
                new Category {Name = "Political", catImage = "/Images/political.jpg"},
                new Category {Name = "Social", catImage = "/Images/social.jpg"},
                new Category {Name = "Economical", catImage = "/Images/economical.jpg"},
                new Category {Name = "Human Rights", catImage = "/Images/humanRights.jpg"},
                new Category {Name = "LGBTQ", catImage = "/Images/lgbt.jpg"},
                new Category {Name = "Animal Rights", catImage = "/Images/animalRights.jpg"},
                new Category {Name = "Enviromental", catImage = "/Images/evironmental.jpg"},
                new Category {Name = "Internatonal", catImage = "/Images/international.jpg"},
                new Category {Name = "Other", catImage ="/Images/other.jpg"}
            ...
            {
                new Cause{CauseID=1, CategoryID = categories.Single( s=> s.Name == "Internatonal").CategoryID, Title="Cause1", createdBy="Username1", UserID=1, createdOn=DateTime.Parse("2005-09-01"), Description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", Target=10 },
                new Cause{CauseID=2, CategoryID = categories.Single( s=> s.Name == "Enviromental").CategoryID, Title="Cause2", createdBy="Username2",  UserID=2, createdOn=DateTime.Parse("2005-08-01"),  Description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", Target=20},
                new Cause{CauseID=3, CategoryID = categories.Single( s=> s.Name == "Animal Rights").CategoryID,Title="Cause3", createdBy="Username3",  UserID= 3, createdOn=DateTime.Parse("2005-02-01"),  Description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", Target=30},
                new Cause{CauseID=4, CategoryID = categories.Single( s=> s.Name == "LGBTQ").CategoryID,Title="Cause4", createdBy="Username4", UserID=4, createdOn=DateTime.Parse("2005-07-01"),  Description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", Target=30},
                new Cause{CauseID=5, CategoryID = categories.Single( s=> s.Name == "Human Rights").CategoryID,Title="Cause5", createdBy="Username5", UserID=5,  createdOn=DateTime.Parse("2005-06-01"),  Description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", Target=40},
                new Cause{CauseID=6, CategoryID = categories.Single( s=> s.Name == "Economical").CategoryID,Title="Cause6", createdBy="Username6", UserID=6, createdOn=DateTime.Parse("2005-05-01"),  Description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", Target=50},
                new Cause{CauseID=7, CategoryID = categories.Single( s=> s.Name == "Social").CategoryID,Title="Cause7", createdBy="Username7", UserID=7,  createdOn=DateTime.Parse("2005-04-01"),  Description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", Target=60}
            };
